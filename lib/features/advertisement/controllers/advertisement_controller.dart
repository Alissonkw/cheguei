...
import 'package:tochegando_delivery_parceiros/common/widgets/custom_bottom_sheet_widget.dart';
...
import 'package:tochegando_delivery_parceiros/features/advertisement/models/advertisement_model.dart';
import 'package:tochegando_delivery_parceiros/features/advertisement/models/popup_menu_model.dart';
import 'package:tochegando_delivery_parceiros/features/advertisement/widgets/ads_create_success_bottom_sheet.dart';
...
import 'package:tochegando_delivery_parceiros/helper/image_size_checker.dart';
...
class AdvertisementController extends GetxController implements GetxService {
  ...
  final List<String> _adsTypes = ['video_promotion', "store_promotion"];
  ...
  Future<void> submitNewAdvertisement({List<TextEditingController>? titleController, List<TextEditingController>? descriptionController, List<Language>? languageList}) async{
    ...
    if(selectedAdsType == AdsType.store_promotion.name){
    ...
    Map<String, String> body = {
      ...
      'dates': "${DateConverterHelper.stringToMDY(dateTimeRange?.start.toString() ?? "")} - ${DateConverterHelper.stringToMDY(dateTimeRange?.end.toString() ?? "")}",
