...
import 'package:tochegando_delivery_parceiros/common/widgets/details_custom_card.dart';
...
import 'package:tochegando_delivery_parceiros/features/store/widgets/information_text_widget.dart';
import 'package:tochegando_delivery_parceiros/features/store/widgets/item_delete_dialog.dart';
import 'package:tochegando_delivery_parceiros/features/store/widgets/title_tag_widget.dart';
import 'package:tochegando_delivery_parceiros/features/store/widgets/variation_view_for_foood_widget.dart';
import 'package:tochegando_delivery_parceiros/features/store/widgets/variation_view_for_general_widget.dart';
        ...
        Expanded(
          child: SingleChildScrollView(
            child: Column(children: [
              ...
              (item.isRejected == 1) && item.note != null && item.note!.isNotEmpty ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [

                TitleTagWidget(title: 'reject_note'.tr),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
